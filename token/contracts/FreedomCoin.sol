...
contract ChainpayContract {
    ...
    constructor(FreedomCoin _token) public {
        token = _token;
        owner = msg.sender;
    }
    ...
    function setTokenAddress(FreedomCoin token_) public onlyOwner {
        require(address(token_) != address(0));
        token = token_;
    }
    
    function getTokenAddress() public view returns(FreedomCoin) {
        return token;
    }
...
contract FreedomCoin is ERC20 {
    ...
    */
    ...
    /**
    * @dev Transfer From Using Chainpay Contract
    */
